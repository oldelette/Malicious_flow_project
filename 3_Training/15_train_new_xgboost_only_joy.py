...
def main():	
	...
	weight_filename = "15_new_xgboost_joy_only.txt"
	...
	filename = result_dir + "15_new_xgboost_joy_only.png"
	...
	plt.savefig(result_dir + "15_new_xgboost_joy_only_importance.png")
	print("-"*80)	
