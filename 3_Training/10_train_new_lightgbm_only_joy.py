...
def main():	
	...
	weight_filename = "10_new_lightgbm_joy_only.txt"
	...
	filename = result_dir + "10_new_lightgbm_joy_only.png"
	...
	plt.savefig(result_dir + "10_new_lightgbm_joy_only_importance.png")
	print("-"*80)	
